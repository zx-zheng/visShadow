...
public class Vector3DDouble
{
	...
	public static double distancexy(Vector3DDouble p1, Vector3DDouble p2)
	{
    double x = p2.x - p1.x;
    double y = p2.y - p1.y;
	...
	public static double distancexy(Vector2DDouble p1, Vector3DDouble p2)
  {
    double x = p2.x - p1.x;
    double y = p2.y - p1.y;
	...
	public static double distancexy(Vector3DDouble p1, Vector2DDouble p2)
  {
    double x = p2.x - p1.x;
    double y = p2.y - p1.y;
